...
**Fourteen views in total**: seven `v_exception_*` rules, plus `v_usermins`, `v_user_daily_billable_hours_base`, `v_user_weekly_billable_hours`, `v_timelog_detail`, `v_task_review`, `v_project_detail` and `v_client_month`.
